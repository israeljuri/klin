...
export type TaskResult = { task_id: string; status: 'pending-model' | 'completed' | 'failed'; context: ContextBundle; model_usage?: ModelUsage; response_id?: string; changed_files?: string[]; error?: string };
